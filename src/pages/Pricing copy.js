          ...
          <div className='boxes price-boxes'>
              <div className='box'> 
                  ...
                  <div className='price-box-price'>
                    ...
                    <dic className='desc'>Limited free version</dic>
                  </div>
              ...
              <div className='box'> 
                  ...
                  <div className='price-box-price'>
                    ...
                    <span className='time'> / month</span>
                    <dic className='desc'>(annual one-time charge of $20)</dic>
                  </div>
                  <div className='buy-button button'>Get Started</div>
              ...
              <div className='box'> 
                  ...
                  <div className='price-box-price'>
                    ...
                    <span className='time'> / month</span>
                    <dic className='desc'>(annual one-time charge of $50)</dic>
                  </div>
                  <div className='buy-button button'>Get Started</div>
              ...
              <div className='box'> 
                  ...
                  <div className='price-box-price'>
                    ...
                    <span className='time'> / month</span>
                    <dic className='desc'>(annual one-time charge of $100)</dic>
                  </div>
                  <div className='buy-button button'>Get Started</div>
